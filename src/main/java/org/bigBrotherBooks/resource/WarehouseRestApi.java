...
import static org.bigBrotherBooks.service.WarehouseService.mapToWarehouse;
...
public class WarehouseRestApi {
    ...
    public Response addWarehouse(@Valid WarehouseDTO warehouseDTO) {
        warehouseService.saveWarehouse(mapToWarehouse(warehouseDTO));
    ...
    public Response updateWarehouse(@Valid WarehouseDTO warehouseDTO) {
        if (warehouseService.updateWarehouse(mapToWarehouse(warehouseDTO))) {
